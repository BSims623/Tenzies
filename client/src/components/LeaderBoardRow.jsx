...
const LeaderBoardRow = (props) => {
    const { user, setUserLookup, convertTime } = useDashboardContext();
    //const isCurrentUser = props.username === user.username;
    //const props = isCurrentUser ? user : props;
    ...
    return (
        <Wrapper className='row bg-dark'>
            ...
            <div className="col py-2"><h4 className='my-0 text-danger'>{convertTime(props.time)}</h4></div>
