            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse d-lg-flex" id="navbarsExample11">
                    ...
                    <ul className="navbar-nav col-lg-3 justify-content-lg-end">
                        ...
                        <Link to='profile' className="profileBtn btn btn-dark my-2 mx-2 d-flex justify-content-center"><img className='me-2' src={user.avatar} alt="Profile Picture" />{user.username}</Link>
